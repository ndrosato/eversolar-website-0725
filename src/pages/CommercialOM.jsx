          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            <Card className="card-hover border-l-4 border-l-red-500">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg sm:text-xl lg:text-2xl">Performance Degradation</CardTitle>
              </CardHeader>
            ...
            <Card className="card-hover border-l-4 border-l-orange-500">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg sm:text-xl lg:text-2xl">Warranty Requirements</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <p className="text-muted-foreground mb-4 text-sm sm:text-base">
            ...
            <Card className="card-hover border-l-4 border-l-blue-500 md:col-span-2 lg:col-span-1">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg sm:text-xl lg:text-2xl">ROI Protection</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <p className="text-muted-foreground mb-4 text-sm sm:text-base">
