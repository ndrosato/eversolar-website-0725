...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        id="home" 
        className="min-h-screen sm:min-h-[500px] md:min-h-screen flex items-center justify-center text-white bg-cover bg-center bg-no-repeat relative"
        style={{
      ...
      >
        <div className="container-max text-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-200 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button 
                  size="lg" 
                  className="btn-primary text-sm sm:text-base px-4 sm:px-6 py-3 sm:py-4"
                  onClick={() => scrollToSection('contact')}
                >
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 border-0 text-sm sm:text-base px-4 sm:px-6 py-3 sm:py-4"
                >
      ...
      <section className="section-padding">
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">Our Process</h2>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  "I've had solar for years but never realised how much performance I was missing until I got regular maintenance. After EverSolar cleaned and inspected my system, I noticed a huge jump in output. It's made a real difference to our energy bill."
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center space-x-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  "We've tried other services before, but none paid as much attention to detail. The team was professional, explained everything clearly, and even gave us a report showing exactly how our performance improved. It feels great knowing our system is finally running at its best."
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center space-x-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  "EverSolar were amazing from start to finish. I wasn't sure if panel cleaning would actually help, but I could literally see the dust and dirt before, and now the system is back to running like new. It's satisfying to get real numbers in their report showing how much more power we're generating."
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center space-x-3">
